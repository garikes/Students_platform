...
def student_home(request):
    ...
    return render(request, "student_template/student_home_template.html",
                  {"total_attendance": attendance_total, "attendance_absent": attendance_absent,
                   ...
                   "data1": data_present, "data2": data_present})
...
def student_view_attendance_post(request):
    ...
    return render(request, "student_template/student_attendance_date.html", {"attendance_reports": attendance_reports})
...
def student_all_notification(request):
    ...
    return render(request, "student_template/all_notification.html", {"notification": notification})


def student_view_result(request):
    student = Students.objects.get(admin=request.user.id)
    student_result = StudentResult.objects.filter(student_id=student.id)
    return render(request, "student_template/student_result.html", {"studentresult": student_result})
