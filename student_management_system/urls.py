"""student_managment_system URL Configuration
...
from student_management_app.EditViewClass import EditResultViewClass
...
urlpatterns = [
                  ...
                  path('staff_taken_attendance', StaffViews.staff_taken_attendance, name="staff_taken_attendance"),
                  path('staff_update_attendance', StaffViews.staff_update_attendance, name="staff_update_attendance"),
                  path('get_student', StaffViews.get_student, name="get_student"),
                  path('get_attendance_dates', StaffViews.get_attendance_dates, name="get_attendance_dates"),
                  path('get_attendance_student', StaffViews.get_attendance_student, name="get_attendance_student"),
                  path('save_attendance_date', StaffViews.save_attendance_date, name="save_attendance_date"),
                  path('save_updateattendance_date', StaffViews.save_updateattendance_date,
                       name="save_updateattendance_date"),
